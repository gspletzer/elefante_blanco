defmodule ElefanteBlancoWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ElefanteBlancoWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ElefanteBlancoWeb.Gettext, "errors", msg, opts)
    end
  end
